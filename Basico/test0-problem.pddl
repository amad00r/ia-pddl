(define (problem menu-semanal-extension-e0)
	...
	(:objects
		...
		sopa_de_lentejas sopa_de_tomate sopa_de_pollo sopa_minestrone sopa_de_verduras ensalada_caprese ensalada_de_quinoa ensalada_de_atun ensalada_cesar ensalada_griega crema_de_champinones crema_de_calabaza crema_de_aguacate crema_de_zanahoria crema_de_esparragos - primero
		estofado_de_cordero costillas_a_la_barbacoa albondigas bacalao_al_horno calamares_a_la_romana salmon_a_la_plancha merluza_en_salsa_verde paella_mixta arroz_meloso_de_verduras - segundo
	)
