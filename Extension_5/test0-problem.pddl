(define (problem menu-semanal-extension-e5)
	...
	(:objects
		...
		sopa_de_tomate sopa_de_pollo sopa_minestrone sopa_de_lentejas sopa_de_verduras ensalada_de_atun ensalada_griega ensalada_de_quinoa crema_de_zanahoria crema_de_calabaza crema_de_champinones crema_de_aguacate crema_de_esparragos - primero
		filete_de_ternera costillas_a_la_barbacoa pollo_asado albondigas estofado_de_cordero calamares_a_la_romana salmon_a_la_plancha arroz_con_costra arroz_a_la_cubana paella_mixta - segundo
	)
	...
	(:init
		...
		(obligatorio_dia arroz_con_costra jue)
		(obligatorio_dia crema_de_calabaza mar)
		(obligatorio_dia sopa_minestrone mie)
